...
public class Vulkan
{
    ...
    public Vulkan(VulkanProperties p)
    {
        ...
        renderSystem = new RenderSystem3d(renderDev, cmd.getRenderPass());
        cmd.attachRenderSystem(renderSystem);
    }
    ...
    public static Device getRenderDevice()
    {
        return renderDev;
    }

    public RenderSystem3d getRenderSystem()
    {
        return renderSystem;
    }
}